function groupAndSortProducts(products){
    let Electronics=products.filter(el=>el.category==="Electronics").sort((a,b)=>b.rating-a.rating)
    let Fashion=products.filter(el=>el.category==="Fashion").sort((a,b)=>b.rating-a.rating)
    let Furniture=products.filter(el=>el.category==="Furniture").sort((a,b)=>b.rating-a.rating)
    let Photography=products.filter(el=>el.category==="Photography").sort((a,b)=>b.rating-a.rating)
